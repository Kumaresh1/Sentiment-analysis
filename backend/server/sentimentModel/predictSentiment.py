...
model = load_model('backend\server\sentimentModel\model.h5')

# Load the tokenizer and encoder
tokenizer = pickle.load(open('backend\server\sentimentModel\\tokenizer.pkl', 'rb'))
encoder = pickle.load(open('backend\server\sentimentModel\encoder.pkl', 'rb'))
